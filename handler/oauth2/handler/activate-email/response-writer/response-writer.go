...
var ErrorJWTValidation ErrorResponse = ErrorResponse{
	Error:            "invalid_activation_token",
	ErrorDescription: "the activation token is malform, forged, or invalid",
	HTTPStatus:       http.StatusUnauthorized,
}

var ErrorUserMissMatch ErrorResponse = ErrorResponse{
	Error:            "invalid_request",
	ErrorDescription: "the requested user is not match with token",
	HTTPStatus:       http.StatusBadRequest,
}
