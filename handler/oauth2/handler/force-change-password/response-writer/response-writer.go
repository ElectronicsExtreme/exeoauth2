...
var ErrorPasswordInvalidCharacter ErrorResponse = ErrorResponse{
	Error:            "invalid_request",
	ErrorDescription: "password contain invalid character",
	HTTPStatus:       http.StatusBadRequest,
}

var ErrorPasswordInvalidLength ErrorResponse = ErrorResponse{
	Error:            "invalid_request",
	ErrorDescription: "password has invalid length",
	HTTPStatus:       http.StatusBadRequest,
}

var ErrorPasswordRemainTheSame ErrorResponse = ErrorResponse{
	Error:            "invalid_request",
	ErrorDescription: "new password is the same as old password",
	HTTPStatus:       http.StatusBadRequest,
}

var ErrorEmailInvalid ErrorResponse = ErrorResponse{
	Error:            "invalid_email",
	ErrorDescription: "specified email is not correct",
	HTTPStatus:       http.StatusUnauthorized,
}

var ErrorPasswordInvalid ErrorResponse = ErrorResponse{
	Error:            "invalid_password",
	ErrorDescription: "old password is not correct",
	HTTPStatus:       http.StatusUnauthorized,
}

var ErrorUIDMissMatched ErrorResponse = ErrorResponse{
	Error:            "invalid_request",
	ErrorDescription: "uid does not match with username",
	HTTPStatus:       http.StatusBadRequest,
}
